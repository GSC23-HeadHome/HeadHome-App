        ...
        return Dialog(
            child: ClipRRect(
              ...
              child: Container(
                ...
                color: Colors.white,
                child: Padding(
                  padding: EdgeInsets.fromLTRB(MediaQuery.of(context).size.height * 0.02, MediaQuery.of(context).size.height * 0.02, MediaQuery.of(context).size.height * 0.02, MediaQuery.of(context).size.height * 0.45),
                  child: Container(
                    height: 80,
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: Switch(
                            ...
                            onChanged: (value) => setState(() => notifications = !notifications),
                          ),
                        ),
                      ],
                    ),
