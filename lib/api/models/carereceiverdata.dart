...
Carereceiver carereceiverFromJson(String str) => Carereceiver.fromJson(json.decode(str));

String carereceiverToJson(Carereceiver data) => json.encode(data.toJson());
...
class Carereceiver {
    ...
    factory Carereceiver.fromJson(Map<String, dynamic> json) => Carereceiver(
        ...
        careGiver: List<CareGiver>.from(json["CareGiver"].map((x) => CareGiver.fromJson(x))),
